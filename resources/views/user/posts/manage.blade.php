                ...
                @foreach($posts as $post)
                    ...
                    <div class = "form-group">
                        ...
                        @elseif($post->requestedBy != NULL)
                            <br><button class="btn disabled btn-danger col-sm-6" style="width: 15em;">This item is requested by<br>another user ( {{ App\User::find($post->requestedBy)->name }} )</button>
                        @else
